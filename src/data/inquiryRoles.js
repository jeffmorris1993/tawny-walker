...
export const ROLES = {
  ...
  agent: {
    ...
    sections: [
      ...
      { type: 'dropdown', multi: true, label: 'Neighborhoods', options: ['Birmingham', 'Bloomfield Hills', 'Royal Oak', 'Ferndale', 'Novi', 'Northville', 'West Bloomfield', 'Farmington Hills', 'Grosse Pointe', 'Other'] },
