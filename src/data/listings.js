...
export const LISTINGS = [
  ...
  { id: 'north-shore',     addr: 'The North Shore',    street: '1411 Pine Lake Road',  loc: 'West Bloomfield, MI',  price: '$6,200,000',  specs: '7 BD · 9 BA · 11,400 SF',            status: 'Sold',    tone: 'night',tag: 'Closed 2026',         img: PHOTOS.kitchenModernWood, blurb: 'A Pine Lake estate, sold off-market in eleven days.' },
  ...
  { id: 'fieldstone',      addr: 'Fieldstone House',   street: '660 Yorkshire Road',   loc: 'Birmingham, MI',       price: '$3,400,000',  specs: '5 BD · 5 BA · 5,100 SF · 0.5 AC',    status: 'Sold',    tone: 'warm', tag: 'Closed 2025',         img: PHOTOS.deck,             blurb: 'A 1936 fieldstone Tudor on half an acre, sold to its second viewer.' },
];
