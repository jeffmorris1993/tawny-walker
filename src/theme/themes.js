...
export const THEMES = {
  ...
  B: {
    ...
    navItems: ['Residences', 'About'],
    indexNoun: 'Residences',
    indexNounSingular: 'Residence',
    listingNoun: 'residences',
    ctaPrimary: 'Begin Your Inquiry',
    ctaSecondary: 'View Current Residences',
    ctaNav: 'Begin Inquiry',
    wordmark: {
    ...
    admin: {
      ...
      navLabels: { Leads: 'Leads', Listings: 'Residences' },
      indexNavKey: 'Listings',
      indexHeadline: 'Residences',
      addCta: '+ Add a Residence',
      composeHeadline: 'residence',
      attachedNoun: 'residence',
      attachedNounPlural: 'residences',
